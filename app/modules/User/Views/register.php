...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <div class="back">&nbsp;</div>
            <form class="form-signin" method="post" action="/user/home/register">
                ...
                <div class="col-lg-12 row">
                    <button class="btn btn-lg btn-primary col-lg-4" type="submit">Register now</button>
                    <div class="col-md-1">&nbsp;</div>
                    <a href="/user/home/index" class="btn btn-lg btn-success col-lg-6">Go to login</a>
                </div>
                <div class="row">&nbsp;</div>
            </form>
